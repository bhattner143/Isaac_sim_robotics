...
# ── Lazy re-export controllers for backward compat ──
# Avoids circular import: controller.controller uses TYPE_CHECKING for
# CupManipulatorTendon, but this module must not eagerly import controller
# at module load.
