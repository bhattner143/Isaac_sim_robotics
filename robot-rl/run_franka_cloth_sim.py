#!/usr/bin/env python3
###########################################################################
# Franka Cloth Manipulation — Newton VBD + Featherstone
#
# Copied from newton/newton/examples/cloth/example_cloth_franka.py
# and made into a standalone runnable script.
#
# Coupled robot-cloth simulation:
#   - VBD solver for the cloth (implicit, self-collision)
#   - Featherstone solver for the Franka articulation
#
# Simulation runs in centimetre scale for VBD numerical stability.
# Visualisation is in metres (viz_scale = 0.01).
#
# Usage:
#   conda activate env_isaacsim
#   python run_franka_cloth_sim.py                     # GL window
#   python run_franka_cloth_sim.py --viewer null        # headless
#   python run_franka_cloth_sim.py --viewer viser       # web viewer
#   python run_franka_cloth_sim.py --num-frames 5000    # longer run
###########################################################################
