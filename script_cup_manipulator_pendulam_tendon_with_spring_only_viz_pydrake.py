...
# On Linux, Isaac Sim's bundled matplotlib may shadow the conda one and
# silently accept 'MacOSX' but crash later — so force 'TkAgg' on Linux.
import matplotlib
...
class IKPDSimulation(Simulation):
    ...
    def build_plant(self):
        ...
        self.manipulator.init_cable_rig(self._URDF_PATH, springs_enabled=not args.no_springs)
    ...
    def run(self, traj_shape: str = 'trajectory'):
        ...
        try:
            ...
            # Temporarily ignore further Ctrl-C so plot() can run
            ...
            # Restore default handler so plt.show() can be interrupted
...
def main():
    ...
    if args.mode == 'scene-viz-q':
        ...
        manipulator.init_cable_rig(_URDF_PATH, springs_enabled=not args.no_springs)
        ...
        try:
            ...
            print(colored("\n  ⚠ Plotting interrupted — check plots/ for saved PNGs.", "yellow"))
        return
