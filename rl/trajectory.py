...
rl/trajectory.py
-----------------
Pure-NumPy trajectory generation — replaces Drake PiecewisePolynomial.

Provides C² (continuous second derivative) cubic spline trajectories for
the cup manipulator computed-torque controller.

Usage::

    from rl.trajectory import RectTrajectory, build_move_to_start
...
class MoveToStartSpline:
    ...
    def __init__(
        ...
        # scipy CubicSpline with explicit derivatives
